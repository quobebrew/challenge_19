...
candidate_database = {
    "Lane": [
        ...
        "4.3",
        0.20,
        "19-Blockchain-Wallets\Challenge_19\Images\lane.jpeg", # had to edit and use the relative path to get this working
    ],
    "Ash": [
        "Ash",
        ...
        "5.0",
        0.33,
        "19-Blockchain-Wallets\Challenge_19\Images\\ash.jpeg", # had to edit and use the relative path and escape the \a to get it working
    ],
    "Jo": [
        "Jo",
        ...
        "4.7",
        0.19,
        "19-Blockchain-Wallets\Challenge_19\Images\jo.jpeg", # had to edit and use the relative path to get this working
    ],
    "Kendall": [
        "Kendall",
        "0x8fD00f170FDf3772C5ebdCD90bF257316c69BA45",
        "4.1",
        0.16,
        "19-Blockchain-Wallets\Challenge_19\Images\kendall.jpeg", # had to edit and use the relative path to get this working
    ],
}
